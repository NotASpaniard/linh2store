<?php
/**
 * AI Chatbot Advanced - Tư duy nâng cao
 * Linh2Store - Chatbot với tư duy mạch lạc và nhận diện cảm xúc
 */

class AIChatbotAdvanced {
    private $db;
    ...
    /**
     * Xử lý tin nhắn với tư duy nâng cao
     */
    public function processMessage($message, $conversationId = null, $userId = null) {
        ...
        $context = $this->analyzeAdvancedContext($message, $conversationHistory);
        
        // Tạo phản hồi dựa trên ngữ cảnh và cảm xúc
        $response = $this->generateAdvancedResponse($context, $message, $conversationHistory);
    ...
    /**
     * Phân tích ngữ cảnh nâng cao
     */
    private function analyzeAdvancedContext($message, $conversationHistory) {
        $message = strtolower(trim($message));
        
        // Kiểm tra cảm xúc và ẩn ý
    ...
    /**
     * Tạo phản hồi nâng cao
     */
    private function generateAdvancedResponse($context, $message, $conversationHistory) {
        switch ($context['type']) {
